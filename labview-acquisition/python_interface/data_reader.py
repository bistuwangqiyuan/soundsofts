"""Read acquisition data produced by the LabVIEW B/S acquisition system."""
...
class AcquisitionRecord:
    """One synchronized acquisition record from the LabVIEW B/S acquisition system."""
    timestamp: float
    position_mm: float
    waveform: np.ndarray
    force_n: float
